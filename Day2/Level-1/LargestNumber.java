...
class LargestNumber {
    public static void main(String[] args){
        ...
        // Taking the number1 as input from the user
        System.out.print("Enter the number 1: ");
        int number1 = scanner.nextInt();
        
        // Taking the number2 as input from the user
        System.out.print("Enter the number 2: ");
        int number2 = scanner.nextInt();
        
        // Taking the number3 as input from the user
        ...
        // Checking which number is the biggest by usinf if-else statements
        if (number1 > number2) {
            if (number1 > number3) {
